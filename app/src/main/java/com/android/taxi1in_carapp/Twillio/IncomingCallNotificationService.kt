...
import com.android.taxi1in_carapp.activity.DashboardActivity
...
/**
    ...
    private fun buildNotification(
        ...
        val piRejectIntent = PendingIntent.getService(applicationContext,
            notificationId,
            rejectIntent,
            PendingIntent.FLAG_IMMUTABLE)
        val acceptIntent = Intent(applicationContext, DashboardActivity::class.java)
        acceptIntent.action = Constants.ACTION_ACCEPT
        acceptIntent.putExtra(Constants.INCOMING_CALL_INVITE, callInvite)
        acceptIntent.putExtra(Constants.INCOMING_CALL_NOTIFICATION_ID, notificationId)
        acceptIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
        val piAcceptIntent = PendingIntent.getActivity(applicationContext,
            notificationId,
            acceptIntent,
            PendingIntent.FLAG_IMMUTABLE)
    ...
    private fun accept(callInvite: CallInvite?, notificationId: Int) {
        endForeground()
        val activeCallIntent = Intent(this, DashboardActivity::class.java)
