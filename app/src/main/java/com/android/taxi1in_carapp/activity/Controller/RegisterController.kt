...
class RegisterController(val context: Context, val view: IRegisterView) : IRegisterController {
    ...
    override fun register(firstname:String, lastName: String, email:String, mobile:String, driverId : String,plateNumber : String, password:String, confirmPassword:String) {

        val call: Call<ResponseBody>? =
            RetrofitHelper.getAPI().register(firstname,lastName,email,mobile,driverId,plateNumber, password, confirmPassword)
        ...
        RetrofitHelper.callApi(call, object : RetrofitHelper.ConnectionCallBack {
            override fun onSuccess(body: Response<ResponseBody?>?) {
                ...
                try {
                    ...
                    val response: SignupResponse = gson.fromJson(reader, SignupResponse::class.java)
