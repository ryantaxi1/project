...
class ResetPasswordController(val context: Context, val view: IResetPasswordView) : IResetPasswordController {
    var dialog: AlertDialog? = null

    override fun resetPassword(email: String, newPassword: String, confirmPassword: String) {
        val call: Call<ResponseBody>? = RetrofitHelper.getAPI().resetPassword(email, newPassword, confirmPassword)
            ...
            override fun onSuccess(body: Response<ResponseBody?>?) {
                ...
                try {
                    ...
                    if (response.status == 1) {
                        ...
                        view.onResetPasswordResponse(response)
