...
class DeleteVehicleController(val context: Context, val view: IDeleteVehicleView) : IDeleteVehicleController {
    var dialog: AlertDialog? = null

    override fun deleteVehicle(vehicleId: String) {
        ...
        val call: Call<ResponseBody>? = RetrofitHelper.getAPI().deleteVehicle(id, token, vehicleId)
            ...
            override fun onSuccess(body: Response<ResponseBody?>?) {
                ...
                try {
                    ...
                    if (response.status == 1) {
                        ...
                        view.deleteVehicleRes(response)
