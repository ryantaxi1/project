...
class AddVehicleController(val context: Context, val view: IAddVehicleView) : IAddVehicleController {
    var dialog: AlertDialog? = null

    override fun addVehicle(plateNumber: String) {
        ...
        val call: Call<ResponseBody>? = RetrofitHelper.getAPI().addVehical(id, token, plateNumber)
            ...
            override fun onSuccess(body: Response<ResponseBody?>?) {
                ...
                try {
                    ...
                    if (response.status == 1) {
                        ...
                        view.onAddVehicle(response)
                        Log.d("AddVehicle", "response: ===" + response)
