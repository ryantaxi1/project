...
class SosHistoryController(val context: Context, val view: ISosHistoryView) : ISosHistoryController {
    var dialog: AlertDialog? = null

    override fun getSOSHistory() {
...
//        val call: Call<ResponseBody>? = RetrofitHelper.getAPI().getProfile("api/listSosCall?id=" + id + "&token=" + token)
        ...
        RetrofitHelper.callApi(call, object : RetrofitHelper.ConnectionCallBack {
            override fun onSuccess(body: Response<ResponseBody?>?) {
                ...
                try {
                    ...
                    val response: SosHistoryResponse = gson.fromJson(reader, SosHistoryResponse::class.java)
