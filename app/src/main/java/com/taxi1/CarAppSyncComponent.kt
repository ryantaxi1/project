...
class CarAppSyncComponent private constructor() : MapboxNavigationObserver {
    ...
    private var tripListener : TripListener? = null

    @SuppressLint("MissingPermission")
    fun setNavigationView(navigationView: NavigationView, tripListener: TripListener) {
