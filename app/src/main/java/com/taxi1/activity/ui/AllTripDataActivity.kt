...
import com.taxi1.activity.Controller.AllTripRecordsController
import com.taxi1.activity.Controller.IAllTripRecordsController
import com.taxi1.activity.Controller.IAllTripRecordsView
import com.taxi1.adapter.AllTripDataAdapter
import com.taxi1.databinding.ActivityAllTripDataBinding
...
class AllTripDataActivity : AppCompatActivity(), AllTripDataAdapter.AllTripListener, IAllTripRecordsView {
    ...
    private var tripDataLists = ArrayList<TripData>()
                    ...
                    object : CustomDialogInterface {
                        override fun positiveClick(dialog: DialogInterface) {
                            ...
                            deletedTrip.tripId?.let {
                                allTripRecordsController?.tripDeleteRecords(deletedTrip.tripId!!)
                            }
    ...
    override fun deleteTripOnResponse(deleteTripResponse: CommanResponse) {
        binding.rvTripData.scrollToPosition(allTripList.size - 1)
    }
