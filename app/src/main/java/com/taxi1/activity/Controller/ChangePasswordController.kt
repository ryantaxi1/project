...
class ChangePasswordController (val context: Context, val view: ICommanView) : IChangePasswordController {
    ...
    override fun changepassword(oldpassword: String, newpassword: String) {
        ...
        val call: Call<ResponseBody>? = RetrofitHelper.getAPI().changepassword(id,token, oldpassword,newpassword)
